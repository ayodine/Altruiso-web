# Altruiso — Pitch for Investment Form

A fully custom, high-converting Typeform-style form built in React (Vite) and styled with a custom CSS Design System matching the Altruiso brand. It collects investment pitches (multi-step UI with text, choice, dropdown, and file-upload steps) and persists submissions to **Firebase Firestore**, with the pitch deck uploaded to **Firebase Storage**.
